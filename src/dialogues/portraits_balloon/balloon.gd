...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		character_label.text = "[b]%s[/b]" % dialogue_line.character
		var res_path = "res://src/dialogues/portraits_balloon/portraits/%s%s.png" % [dialogue_line.character.to_lower(), file_suffix]
		var has_portrait = ResourceLoader.exists(res_path)
		if has_portrait:
			character_portrait.get_parent().show()
			character_portrait.texture = load(res_path)
		else:
			character_portrait.get_parent().hide()
